...
<div class="col-lg-12">
                 ...
                 <table  class="display table table-bordered table-striped" id="example">
                    <thead>
                        <tr> 
							<th width="5%">No</th><th>Produk</th><th>Images</th><th width="10%">Aksi</th>
			  			</tr>
                    </thead>
					 <tbody>
                   <?php $no=1;
        ...
        <tr>
		<td><?php echo $no;?></td>
        <td><?php echo $modul->name_uploads;?></td>
                          ...
                          <font color="#FF0000"><?=$msg?></font>
                              <form class="form-horizontal tasi-form" action="<?= $act ;?>" method="post" enctype="multipart/form-data">
                              	  <div class="form-group">
                                      ...
                                      <div class="col-sm-10">
                                          <input type="text"  class="form-control" name="name_uploads" value="<?=$currentModul->name_uploads?>" required>
                                      </div>
                                  </div>
                                  <div class="form-group">
                                      <label class="col-sm-2 col-sm-2 control-label">Deskripsi</label>
                                      <div class="col-sm-10">
                                      		<textarea class='ckeditor' cols='80' rows='5' name='desc_uploads'  class='longinput'><?= $currentModul->desc_uploads ?></textarea>
                                      </div>
                                  </div>
                                  <div class="form-group">
