...
$strSubject = "Barang telah kami kirim, Order id: ".$currentOrder->invoice;
...
Barang yang anda pesan telah kami kirimkan ke alamat pengiriman anda. Jika dalam waktu 

7 hari dari tanggal pengiriman barang belum sampai ke tangan anda, silahkan konfirmasikan 

kepada CS kami.<br><br> Berikut adalah detail order anda :<br /><br />
...
Informasi Pengiriman :<br /><br />
		<table>
			...
			<tr>
                <td width='150'>Ekspedisi</td><td>". $currentOrder->jasa."</td>
            </tr>
			<tr>
                <td width='150'>No Resi Pengiriman</td><td>". $currentOrder->resi."</td>
            </tr>
        </table><br>
		<br />
