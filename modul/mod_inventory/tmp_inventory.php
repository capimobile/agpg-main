...
<!--                                       <div class="col-sm-2">
                          ...
                          <br />
                          <?php if ($_GET['from'] AND $_GET['from']){?>
                          <div align="center">
                          	<a href="web/laporan_stock.php?from=<?=$_GET['from']?>&to=<?=$_GET['from']?>"> <button type="button" class="btn btn-success">Download PDF</button></a>
                          </div>
                          <?php }?>
                          <h4>Laporan Stock : <?=changedate($_GET['from'])?> - <?=changedate($_GET['from'])?></h4>
