...
<div class="col-lg-12">
                 ...
                 <table  class="display table table-bordered table-striped">
                                      ...
                                      <tr>
                                          ...
                                          <td><?=selectQ('members', 'id_members', selectQ('cabang', 'id_cabang', $r['id_cabang'], 'id_members'), 'name_members')?></td>
                                          <td>
                                          	<a href="<?="?page=$page&act=view"?>&id=<?=Baggeo_Encrypt($r['id_orders'])?>" title="View" class="btn btn-success btn-xs">View</a>
                                            <a href="<?="?page=$page&act=bayar"?>&id=<?=Baggeo_Encrypt($r['id_orders'])?>" title="View" class="btn btn-warning btn-xs">Pembayaran</a>
                                          </td>
                                      </tr>    
                                      <?php $no++; } ?>     
                                      </tbody>      
