...
$orderss="(SELECT * FROM orders o LEFT JOIN cabang c ON c.id_cabang = o.id_cabang WHERE o.status_order=0 $dates $searchsql ORDER BY o.id_orders ASC LIMIT $posisi,$batas)";
