...
<div class="col-lg-12">
                      <section class="panel">
                          ...
                          <?php if(isset($_GET['tablepage'])){
                			 ...
                			 <iframe src="web/fee.php?tanggal=<?=$dates?>&tablepage=<?=$paging?>&users=<?=$_SESSION[user_id]?>" width="100%" height="350" frameborder="0"/></iframe>
                      <div class="text-center">
                          <?php
						  $jmldata     = querynum3('cabang', "id_users='".$_SESSION[user_id]."'");
						  $jmlhalaman  = $p->jumlahHalaman($jmldata, $batas);
						  $currentpage = $p->currentpage("?page=$_GET[page]$pluscur");
