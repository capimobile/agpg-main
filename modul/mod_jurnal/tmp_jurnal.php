 ...
 default:  ?>
                  ...
                  <div class="col-lg-12">
                      <section class="panel">
                          ...
                          <br />
                          <a href="<?= "?page=$page&act=form"; ?>"> <button type="button btn-sm" class="btn btn-success">Input Data</button></a>
                          <?php if ($_GET['from'] AND $_GET['to']){?>
                          <!--<div align="center">
                            <a href="web/jurnal_export.php?from=<?=$_GET['from']?>&to=<?=$_GET['to']?>"> <button type="button" class="btn btn-success">Download PDF</button></a>
                          </div>-->
                          <?php }?>
...
<!--                                       <?php
                                      ...
                                      ?>
                                      <tr>
                                        <td colspan="2" align="left" style="font-size:12px; font-weight:bold; padding:5px 10px;">TOTAL PEMASUKAN</td>
                                        <td colspan="6"style="font-size:12px; font-weight:bold;">Rp. <?php echo rupiah($r->total_out)?></td>
                                      </tr>
                                      <?php }?>
                                      <?php
                                      ...
                                      ?>
                                      <tr>
                                        <td colspan="2" align="left" style="font-size:12px; font-weight:bold; padding:5px 10px;">TOTAL PENGELUARAN</td>
                                        <td colspan="6"style="font-size:12px; font-weight:bold;">Rp. <?php echo rupiah($r->total_in)?></td>
                                      </tr>
                                      <?php }?> -->
                                      </tbody>        
                          </table>
                          ...
                          <div align="center" style="padding-bottom: 20px;">
                            <a href="web/jurnal_export.php?from=<?=$_GET['from']?>&to=<?=$_GET['to']?>" target="_blank"> <button type="button" class="btn btn-success">Download Excel</button></a>
                          </div>
                      </section>
