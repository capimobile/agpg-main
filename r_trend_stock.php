...
$stock_in = (int)stockIn(1, date('Y-m-d'), date('Y-m-d'));
$stock_out = (int)Sold(1, date('Y-m-d'), date('Y-m-d'));
$stock_disposal = (int)stockDis(1, date('Y-m-d'), date('Y-m-d'));
...
// echo("AYAM :".(int)Sold(1, date('Y-m-d'), date('Y-m-d'))."");
// echo("<br/>");
echo("DLL :".(int)Sold(1, '2017-08-14', '2017-08-14')."");
// echo("<br/>");
